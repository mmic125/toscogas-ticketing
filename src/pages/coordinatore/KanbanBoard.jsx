...
const COLONNE = [
  { stato: 'nuovo',          colore: 'border-blue-400',   sfondo: 'bg-blue-50',   titolo: 'Nuovo' },
      ...
      {ticket.manutentore && (
        <div className="mt-1 flex items-center gap-1">
          ...
          <span className="text-xs text-gray-500">
            {ticket.manutentore.nome} {ticket.manutentore.cognome}
          </span>
        </div>
      )}
    </div>
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">{tickets.length} ticket totali</p>
        </div>
        <input
          type="text"
          value={cerca}
