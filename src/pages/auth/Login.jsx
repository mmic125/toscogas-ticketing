        ...
        {!modalReset ? (
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  <IconOcchio aperto={mostraPassword} />
                </button>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500">
              ...
              <a href="mailto:simone.lorenzi@toscogas.it" className="text-red-600 hover:underline">
                simone.lorenzi@toscogas.it
              </a>
