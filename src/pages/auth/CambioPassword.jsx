    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_API_URL || ''}/auth/change-password`,
        {
          ...
          body: JSON.stringify({ nuova_password: form.nuova }),
        }
      )
      ...
      if (profilo?.ruolo === 'coordinatore')                navigate('/coordinatore', { replace: true })
      else if (profilo?.ruolo === 'segnalatore')            navigate('/segnalatore',  { replace: true })
      else if (profilo?.ruolo === 'manutentore')            navigate('/manutentore',  { replace: true })
      else if (profilo?.ruolo === 'segnalatore_manutentore') navigate('/segnalatore', { replace: true })
